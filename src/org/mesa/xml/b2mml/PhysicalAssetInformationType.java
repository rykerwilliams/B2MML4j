 ...
 *         &lt;element name="PhysicalAssetClass" type="{http://www.mesa.org/xml/B2MML-V0600}PhysicalAssetClassType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="PhysicalAssetCapabilityTestSpecification" type="{http://www.mesa.org/xml/B2MML-V0600}PhysicalAssetCapabilityTestSpecificationType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;group ref="{http://www.mesa.org/xml/B2MML-V0600-AllExtensions}PhysicalAssetInformation" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PhysicalAssetInformationType {
    ...
    protected List<PhysicalAssetCapabilityTestSpecificationType> physicalAssetCapabilityTestSpecification;
     ...
     * 
     */
    public List<PhysicalAssetCapabilityTestSpecificationType> getPhysicalAssetCapabilityTestSpecification() {
        if (physicalAssetCapabilityTestSpecification == null) {
            physicalAssetCapabilityTestSpecification = new ArrayList<PhysicalAssetCapabilityTestSpecificationType>();
        }
