...
public class EquipmentElementType implements Serializable
{
    ...
    protected List<Serializable> equipmentElementOrEquipmentElementID;
     ...
     * 
     */
    public List<Serializable> getEquipmentElementOrEquipmentElementID() {
        if (equipmentElementOrEquipmentElementID == null) {
            equipmentElementOrEquipmentElementID = new ArrayList<Serializable>();
        }
