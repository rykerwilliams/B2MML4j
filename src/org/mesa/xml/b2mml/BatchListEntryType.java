    ...
    implements Serializable
{
    ...
    protected List<Serializable> equipmentIDOrEquipmentClassID;
     ...
     * 
     */
    public List<Serializable> getEquipmentIDOrEquipmentClassID() {
        if (equipmentIDOrEquipmentClassID == null) {
            equipmentIDOrEquipmentClassID = new ArrayList<Serializable>();
        }
